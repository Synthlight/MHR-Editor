...
public partial class Snow_data_PlHyakuryuSkillRecipeUserData_Param : ICraftingCost {
    [DisplayName("")]
    public ObservableCollection<DataSourceWrapper<uint>> ItemIdList {
        get => RecipeItemIdList;
        set => RecipeItemIdList = value;
    }

    [DisplayName("")]
    public ObservableCollection<GenericWrapper<uint>> ItemNumList {
        get => RecipeItemNumList;
        set => RecipeItemNumList = value;
    }
}