...
public static class SwapDbTweakWriter {
    public static void WriteTweak(SwapDbTweak tweak, string modFolderName) {
        ...
        var changesGroupedByDatabaseAndGender = new Dictionary<string, Dictionary<App_Gender, List<SwapDbTweak.Change>>>();
