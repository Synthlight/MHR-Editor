...
public partial class Snow_data_DecorationsBaseUserData_Param : IGem {
    [SortOrder(50)]
    public string Name => DataHelper.DECORATION_NAME_LOOKUP[Global.locale].TryGet((uint) Id);

    [SortOrder(int.MaxValue)]
    public string Description => DataHelper.DECORATION_DESC_LOOKUP[Global.locale].TryGet((uint) Id);
