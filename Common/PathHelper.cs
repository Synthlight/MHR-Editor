...
public static class PathHelper {
    ...
    public const string ENUM_HEADER_PATH = @"C:\SteamLibrary\common\RESIDENT EVIL 4  BIOHAZARD RE4\Enums_Internal.hpp";
    ...
    [SuppressMessage("ReSharper", "StringLiteralTypo")]
    public static List<string> NEW_GAME_INVENTORY_MC_DATA_PATHS = new() {
