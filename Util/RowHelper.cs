...
public static class RowHelper {
    public static void AddKeybinds<T>(UIElement control, IList<T> items, AutoDataGridGeneric<T> dataGrid) {
        Utils.SetupKeybind(control, new KeyGesture(Key.I, ModifierKeys.Control), () => HandleAddRow(items, dataGrid));
        Utils.SetupKeybind(control, new KeyGesture(Key.R, ModifierKeys.Control), () => HandleRemoveRow(items, dataGrid));
    }

    public static void HandleAddRow<T>(IList<T> items, AutoDataGridGeneric<T> dataGrid) {
